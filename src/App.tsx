      ...
      <main className="spec-shell">
        <header className="spec-toolbar">
          <div className="search-field">
            <Search size={16} />
            <span>LazyDesign Specification v0.1</span>
          </div>
          ...
          <article className="spec-document">
            ...
            <section className="spec-section" id="theme">
              ...
              <pre className="code-block">
                <code>{`type LazyThemeInput =
  | { brandColor: string; mode?: "light" | "dark"; contrast?: "normal" | "high" }
  | { image: File; mode?: "light" | "dark"; contrast?: "normal" | "high" };

const theme = createLazyTheme(input);
